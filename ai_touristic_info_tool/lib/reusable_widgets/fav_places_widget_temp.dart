...
class FavPlacesWidgetTemp extends StatefulWidget {
  const FavPlacesWidgetTemp({super.key});

  @override
  State<FavPlacesWidgetTemp> createState() => _FavPlacesWidgetTempState();
}

class _FavPlacesWidgetTempState extends State<FavPlacesWidgetTemp> {
