...
class ProcessContainerWidgetTemp extends StatefulWidget {
  final String query;
  final String city;
  final String country;
  const ProcessContainerWidgetTemp(
      {super.key, required this.query, this.city = '', this.country = ''});

  @override
  State<ProcessContainerWidgetTemp> createState() => _ProcessContainerWidgetTempState();
}

class _ProcessContainerWidgetTempState extends State<ProcessContainerWidgetTemp> {
