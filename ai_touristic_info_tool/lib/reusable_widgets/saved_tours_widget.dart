                              ...
                              children: [
                                ...
                                Text(
                                  _favTours[index].isGenerated
                                      ...
                                      // ? 'Generated by Gemini'
                                      // : 'Customized Tour',
                                      ? AppLocalizations.of(context)!.favTours_generatedByGemini
                                      : AppLocalizations.of(context)!.favTours_customized,
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  Text(
                                    // 'Visualize',
                                    AppLocalizations.of(context)!.defaults_visualize,
                                      style: TextStyle(
                                        fontSize: value.fonts.textSize - 10,
                                        fontFamily: fontType,
                                        color: value.fonts.primaryFontColor,
                              ...
                              Column(
                                children: [
                                  ...
                                  Text(
                                    // 'Remove',
                                    AppLocalizations.of(context)!.defaults_remove,
                                      style: TextStyle(
                                        fontSize: value.fonts.textSize - 10,
                                        fontFamily: fontType,
                                        color: value.fonts.primaryFontColor,
