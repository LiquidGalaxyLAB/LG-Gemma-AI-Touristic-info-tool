...
# # Define the LangServe handler
# @app.post("/rag/stream_places")
# async def get_places(query: Query):

#         general_fetched_urls = scrape_urls(query.query)
...
#         #     async for chunk in rag_chain.astream({"question": query.query}):
#         #         yield chunk
#         #         print(chunk)
...
#         # # #result = await rag_chain.astream({"question": user_query})
#         # result = ''
#         # async for chunk in rag_chain.astream({"question": user_query}):
#         #     yield chunk  # Stream the item
#         #     result+=chunk  # Collect the item
#         #     print(chunk)
            
 
#         # parsed_result = parser.parse(results)
#         # vectorstore.delete_collection()
...
# #     stream = create_retrieval_chain(query)
